...
Achieving a 90+ Lighthouse score on a complex eCommerce store built on a monolithic platform (like standard Shopify or Magento) is nearly impossible. To hit 100/100, you must migrate to a modern [Next.js architecture](/solutions/build) and implement aggressive optimizations.
...
**The Next.js Solution:**
We implement the [`next/image` component](/hire/nextjs-developers). This automatically intercepts every image request and dynamically converts the image to modern, highly compressed formats like WebP or AVIF based on the user's specific browser capabilities. 
...
At Oktuv, we implement tools like **Partytown.js** within your [Next.js architecture](/hire/nextjs-developers). Partytown takes all of these heavy, resource-draining marketing scripts and moves them off the browser's "Main Thread" and into "Web Workers." 
