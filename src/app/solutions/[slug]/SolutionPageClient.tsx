...
import { solutionCategories, iconMap, type SolutionCategory } from '@/data/solutions';
...
export default function SolutionPageClient({ category }: SolutionPageClientProps) {
