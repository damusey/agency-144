...
export default function ClientsBar() {
  ...
  return (
    <section style={{ padding: '40px 0 48px', borderTop: '1px solid var(--border)', borderBottom: '1px solid var(--border)', background: 'rgba(255,255,255,0.01)', backdropFilter: 'blur(8px)', position: 'relative', overflow: 'hidden' }}>
      ...
      <div style={{ position: 'absolute', top: 0, bottom: 0, left: 0, width: 'min(150px, 100vw)', background: 'linear-gradient(to right, var(--surface) 0%, transparent 100%)', zIndex: 10, pointerEvents: 'none' }} />
      <div style={{ position: 'absolute', top: 0, bottom: 0, right: 0, width: 'min(150px, 100vw)', background: 'linear-gradient(to left, var(--surface) 0%, transparent 100%)', zIndex: 10, pointerEvents: 'none' }} />
      ...
      <div className="marquee-container" style={{ width: '100%', maxWidth: '100%' }}>
